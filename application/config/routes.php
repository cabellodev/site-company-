...
$route['comprobantes']['GET']='Comprobantes/create_comprobantes';
$route['adminPeticion']['GET']='Peticiones/adminPeticion';
// api 
...
$route['api/changeState']['POST'] = 'User/changeState';
$route['api/getPeticion']['GET']='Peticiones/getPeticion';
$route['api/editPeticion']['POST'] = 'Peticiones/editPeticion';
$route['api/getEstados']['GET'] = 'Peticiones/getEstados';